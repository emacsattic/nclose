...
;; NOTE - An experimental implementation of NClose in ELisp for Emacs
...
(require 'nclose-advice)
(require 'nclosemacs-lib)


  ;; This, being advised, is necessary as the first command
  (nclose-init-advices)
  (nclose-global-init)
...
;; Thu Oct 30 10:03:00 2008
;; Using system-wide variables in ontology pattern expressions in LHS
;; Resetting slots differentially
;; On-demand loading of nclos models
;; XTM, EIEIO models
;; Class-typed slots and new patterns operators and commands
;; Gating on objects/slots
